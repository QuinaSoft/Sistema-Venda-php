...
<body>
	...
	<section id="container">
		...
		<a href="registro_proveedor.php" class="btn_new">Cadastrar provedores</a>
...
<?php
				...
				//Paginador
				$sql_registe = mysqli_query($conexao, "SELECT COUNT(*) as total_registro FROM proveedor WHERE estatus = 1");
				...
				$query = mysqli_query($conexao,"SELECT * FROM proveedor WHERE estatus = 1 ORDER BY codproveedor ASC LIMIT $desde,$por_pagina
					");
